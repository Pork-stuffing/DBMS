...
<body class="bootstrap-admin-with-small-navbar">
					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal" action="/book/selectServlet"
									method="post">
    ...
    function deleteUser(uid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/book/user?method=delUser&uid="+uid;
    	}
    }
    </script>
	<!-- 修改模态框（Modal） -->
	...
	<form class="form-horizontal" method="post" 
		action="/book/user?method=updUser">
		<!--保证样式水平不混乱-->
	...
	<form class="form-horizontal" method="post" onsubmit="return checkAdd()"
		action="/book/user?method=addUser">
		<!--保证样式水平不混乱-->
		<!-- 模态框（Modal） -->
